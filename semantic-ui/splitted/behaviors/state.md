...
State is designed to make the process of integrating data sources to UI components seamless, [tying State request state](#state-state-management) to UI states automatically.
